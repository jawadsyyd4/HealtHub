        ...
        <div className='flex flex-col md:flex-row flex-wrap bg-[#C0EB6A] rounded-lg px-4 md:px-6 lg:px-8'>
            ...
            <div className="md:w-1/2 flex flex-col items-start justify-center gap-4 py-6 m-auto md:py-[5vw] md:mb-[-30px]">
                ...
                <div className="flex flex-col md:flex-row items-center gap-3 text-white text-sm font-light">
                    <img loading="lazy" className='w-28' src={assets.group_profiles} alt="" />
                ...
                >
                    Book Appointment <img loading="lazy" className="w-3" src={assets.arrow_icon} alt="Arrow icon" />
                </button>
                ...
                >
                    View Available Doctors <img loading="lazy" className="w-3" src={assets.arrow_icon} alt="Arrow icon" />
                </button>
            </div>
